...
const defaultData = {
    ...
    tasks: [
        { id: 'task1', title: 'Görev 1 — Web Sitesi', image: 'https://raw.githubusercontent.com/umitcancinar/STNM_DESTEK/main/STNM_IMAGES.png', desc: 'STNM takımının/başvuru sürecinin ihtiyaçlarına uygun, temel bir web sitesi içeriğinin hazırlanması istenmektedir.', link: '#' },
        { id: 'task2', title: 'Görev 2 — Görüntü İşleme', image: 'https://raw.githubusercontent.com/umitcancinar/STNM_DESTEK/main/STNM_IMAGES.png', desc: 'Görüntü işleme alanında bir uygulama veya proje (örn. renk tanıma) hazırlanması istenmektedir.', link: '#' },
        { id: 'task3', title: 'Görev 3 — Gazebo Ortamında Drone Simülasyonu Kurulumu', image: 'https://raw.githubusercontent.com/umitcancinar/STNM_DESTEK/main/STNM_IMAGES.png', desc: 'Gazebo üzerinde herhangi bir drone simülasyon ortamı (örn. ArduPilot SITL) kurulması istenmektedir.', link: '#' },
        { id: 'task4', title: 'Görev 4 — Proteus Ortamında Gömülü Rover Simülasyonu', image: 'https://raw.githubusercontent.com/umitcancinar/STNM_DESTEK/main/STNM_IMAGES.png', desc: 'Tinkercad veya Proteus ortamında motor kontrolü üreten basit bir rover kontrol sistemi.', link: '#' },
        { id: 'task5', title: 'Görev 5 — Web Teknolojileri Araştırma Raporu ve Uygulaması', image: 'https://raw.githubusercontent.com/umitcancinar/STNM_DESTEK/main/STNM_IMAGES.png', desc: 'Web geliştirme alanında ileri seviye bir framework seçilerek detaylı bir araştırma raporu ve uygulama.', link: '#' },
        { id: 'task6', title: 'Görev 6 — Görüntü İşleme Araştırma Raporu', image: 'https://raw.githubusercontent.com/umitcancinar/STNM_DESTEK/main/STNM_IMAGES.png', desc: 'Görüntü işleme kavramlarının veya algoritmalarının detaylı araştırma raporu.', link: '#' },
        { id: 'task7', title: 'Görev 7 — Simülasyon / Robotik Araştırma Raporu', image: 'https://raw.githubusercontent.com/umitcancinar/STNM_DESTEK/main/STNM_IMAGES.png', desc: 'Simülasyon veya robotik alanında bir sistem, yöntem raporlandırması.', link: '#' },
        { id: 'task8', title: 'Görev 8 — Gömülü Sistemler Araştırma Raporu', image: 'https://raw.githubusercontent.com/umitcancinar/STNM_DESTEK/main/STNM_IMAGES.png', desc: 'Gömülü sistemler mimarisine ve donanıma dair kavramsal raporlama görevi.', link: '#' }
    ],
